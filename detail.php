...
<body>
	...
	<article id="w1Detail" class="detail">
		<header>
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
			...
			<div class="row">
					...
					<section id="trainerList">
						...
						<div class="trainer row">
							...
							<div class="col-xs-12 col-sm-8">
								...
								<p>
									Diseñador todo terreno en [Q] interactiva.<br/>
									Autor de criteriondg.info<br/>
									Formador en video2brain.
								</p>
								<a href="http://criteriondg.info/portafolio" class="trainer-link">CV online</a><a href="https://twitter.com/skeku" class="trainer-link">@skeku</a>
							</div>
						</div>
					</section>
				</div>
				<div class="col-xs-12 col-sm-5">
					<section id="registration">
						<h3>Registro</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae fuga veritatis velit nam distinctio at totam, provident officia impedit, qui voluptate ipsa aspernatur dolorum. Autem iste blanditiis quo harum, aspernatur?</p>
						<div class="registrationBadge">
							...
							<a href="#" class="doRegister">ME APUNTO!</a>
						</div>
					</section>
					<section id="agenda">
		...
		<section id="locationInfo">
			...
			<div class="container">
				<div class="row">
					<div id="hotelInfo" class="col-xs-12 col-sm-5 col-sm-offset-2">
	...
	<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbWFockZO4l_agoRCksdoLHDsRXVRStfo&callback=initialize"
